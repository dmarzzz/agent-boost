...
test("saved-wallet routing pins exact names from natural named and positional wrappers", async (t) => {
  ...
  const namedWalletLoads = [
    ...
    ["Load my saved wallet agent-boost and make it active.", "agent-boost"],
    [
      "Load the saved wallet named exactly agent-boost-eac63c72e6a7a0d2 and make it active.",
      "agent-boost-eac63c72e6a7a0d2",
    ],
    ["Load my saved wallet \"AGENT-BOOST\" and make it active.", "AGENT-BOOST"],
    ["Load my saved wallet \uFF41\uFF47\uFF45\uFF4E\uFF54\uFF0D\uFF42\uFF4F\uFF4F\uFF53\uFF54 and make it active.", "agent-boost"],
    [
      "load wallet agent-boost-and-make-it-active and make it active",
      "agent-boost-and-make-it-active",
    ],
    ["load wallet active and make it active", "active"],
    ["load wallet and and make it active", "and"],
